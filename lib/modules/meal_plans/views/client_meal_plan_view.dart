...
class ClientMealPlanView extends GetView<ClientMealPlanController> {
  const ClientMealPlanView({super.key});
  @override
  Widget build(BuildContext context) {
    // Using a Container instead of a Scaffold since this view
    // is now embedded within the main dashboard Scaffold
    return Container(
      color: Colors.black,
      child: SafeArea(
        child: Obx(
